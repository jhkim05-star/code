...
const CACHE = 'workout-log-v25-simple-planning-review';
...
const CORE = [
    ...
    './js/exercises.js', './js/weights.js', './js/timing.js', './js/planner.js', './js/today-plan.js', './js/free-summary.js', './js/runner.js', './js/voice.js', './js/ai.js', './js/ai-contract.js', './js/stats-model.js',
    './js/views/planTab.js', './js/views/todayWorkout.js', './js/views/planPreview.js', './js/views/dayEditor.js', './js/views/machinePicker.js', './js/views/execTab.js', './js/views/exercisePicker.js', './js/views/run.js', './js/views/history.js', './js/views/stats.js', './js/views/settings.js',
    './audio/manifest.json',
];
const OPTIONAL = [
