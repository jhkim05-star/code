...
export const DEFAULT_SETTINGS = {
    ...
    plan: {
        equipment: [], variantsPerGroup: 2, sessionMinutes: 60, warmup: false,
        rotationMode: 'stable', stableWeeks: 4, blockAnchor: '2024-01-01',
        goal: 'general', experience: 'unknown', targetRir: 2,
        weeklyTargets: { chest: 8, back: 8, delt_f: 4, delt_sr: 6, biceps: 6, triceps: 6, thighs: 8, glutes: 6, calves: 6, core: 4 },
