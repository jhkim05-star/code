...
const routes = [[/^\/plan(?:\/(long-term|today))?$/, renderPlanTab], [/^\/exec(?:\/(\d{4}-\d{2}-\d{2}))?$/, renderExec], [/^\/run\/(\d{4}-\d{2}-\d{2})$/, renderRun, true], [/^\/history$/, renderHistory], [/^\/session\/([\w-]+)$/, renderSessionDetail], [/^\/stats$/, renderStats], [/^\/settings$/, renderSettings]];
