...
export const EXERCISES = [
  ...
  e('pullup',        '풀업',                   'back', 1, 4, 8,  150, '맨몸', 3.5),
  e('chinup',        '친업',                   'back', 1, 4, 8,  150, '맨몸', 3.5),
  ...
  // ── 하체 ────────────────────────────────────────────────
  e('back_squat',    '백스쿼트',               'legs', 1, 5, 6,  180, '바벨', 3.5),
  e('front_squat',   '프론트 스쿼트',          'legs', 1, 4, 8,  180, '바벨', 3.5),
  e('leg_press',     '레그프레스',             'legs', 1, 4, 12, 120, '머신'),
  e('hack_squat',    '핵 스쿼트',              'legs', 1, 4, 10, 150, '머신'),
  e('rdl',           '루마니안 데드리프트',    'legs', 1, 4, 10, 150, '바벨', 3.5),
  e('stiff_dl',      '스티프레그 데드리프트',  'legs', 2, 3, 12, 120, '바벨', 3.5),
  e('bulgarian',     '불가리안 스플릿 스쿼트', 'legs', 2, 3, 12, 105, '덤벨'),
  e('lunge',         '워킹 런지',              'legs', 2, 3, 12, 105, '덤벨'),
  e('leg_ext',       '레그 익스텐션',          'legs', 3, 3, 15, 60,  '머신', 2.5),
  e('leg_curl',      '레그 컬',                'legs', 2, 4, 12, 75,  '머신'),
  e('hip_thrust',    '힙 스러스트',            'legs', 2, 3, 12, 105, '바벨'),
  e('calf_raise',    '스탠딩 카프 레이즈',     'legs', 3, 4, 15, 45,  '머신', 2),
  e('seated_calf',   '시티드 카프 레이즈',     'legs', 3, 4, 15, 45,  '머신', 2),

  // ── 코어 ────────────────────────────────────────────────
  e('hang_leg',      '행잉 레그레이즈',        'core', 2, 3, 12, 60, '맨몸'),
...
/** 부위별 종목을 tier 순으로 */
export function byGroup(groupId, custom = []) {
  return allExercises(custom)
    .filter(x => x.group === groupId)
